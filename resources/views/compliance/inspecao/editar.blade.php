	...
	<div  class="row col s12">
		...
		<form action="{{route('compliance.inspecao.atualizar', $id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                style="{{(isset($registro->preVerificar) && $registro->preVerificar == 'Sim'  ? 'display:block;' : 'display:none;')}};"
                ...
                <div id="modal1" class="modal modal-fixed-footer">
                    ...
                    <div class="row"><!------    teste de opções  ----->
                        ...
                        <div>
                            ...
                            @endif
                            @if(($registro->numeroGrupoVerificacao==272)&&($registro->numeroDoTeste==1))
                            ...
                            @endif
                            @if(($registro->numeroGrupoVerificacao==273)&&($registro->numeroDoTeste==1))
                            ...
                            @endif
                            @if(($registro->numeroGrupoVerificacao==275)&&($registro->numeroDoTeste==1))
                            ...
                            @endif
                            @if(($registro->numeroGrupoVerificacao==277)&&($registro->numeroDoTeste==4))

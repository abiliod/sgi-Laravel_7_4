...
// Início teste Controle de Bens Móveis
        if((($registro->numeroGrupoVerificacao==233) && ($registro->numeroDoTeste==1))
            || (($registro->numeroGrupoVerificacao==233) && ($registro->numeroDoTeste==1)))
        {

//            mapear quais tipos de inspeções e adequar ao item
        }
// Início teste Controle de Bens Móveis
